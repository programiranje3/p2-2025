...
# print(bj._Musician__n)
# print(bj._m)
# print(bj.immutable_property)
...
# bj = Singer('Billy Joe Armstrong', Vocals.LEAD_VOCALS)
# print(bj)
# print(Singer.__mro__)
# print(bj == Singer('Ringo Starr', Vocals.LEAD_VOCALS))
# print()
# bj = Songwriter('Ringo Starr', Instrument.DRUMS)
# print(bj)
# print(bj == Songwriter('Ringo Starr', Instrument.DRUMS))
# print(bj.what_do_you_do())

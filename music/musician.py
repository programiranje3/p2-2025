...
class Musician:
    ...
    def __str__(self):
        return f'{self.name} (band member)' if self.is_band_member else f'{self.name} (solo musician)'
    ...
    def play(self, song_title, *args, **kwargs):
        ...
        return f'{self.name} playing {song_title}: {rc} ... {g} {m}'
    ...
    def from_str(cls, musician_string):
        ...
        # is_band_member = True if 'band member' in musician_string else False
...
#%%
# Print objects
ringo = Musician('Ringo Starr')
print(ringo)

#%%
# Compare objects
print(ringo.__dict__)
print(ringo == Musician('Ringo Starr'))
...
# ringo = Musician('Ringo Starr')
# # print(ringo.__n)
# # print(ringo._Musician__n)
# # print(ringo._m)
# print(ringo.immutable_property)
# ringo.immutable_property = 674
...
ringo = Musician('Ringo Starr')
print(ringo.__dict__)
ringo.birth_year = 1940
print(ringo.__dict__)

#%%
# Calling methods
ringo = Musician('Ringo Starr')
print(ringo.play('Don\'t Pass Me By', *['Thank you!', 'Thanks!'],
                 rhythm_count='One, two, three, four!', love='We love you!'))
print(ringo.play_song('Don\'t Pass Me By', *['Thank you!', 'Thanks!'],
                      rhythm_count='One, two, three, four!', love='We love you!'))
...
print(ringo.__class__.__name__)
print((1).__dir__())
print(ringo.__dir__())
...
ringo = Musician.from_str('Ringo Starr (band member)')
print(ringo)
...
class Singer(Musician):
    ...
    def play(self, song_title, *args, **kwargs):
        ...
        return super().play(song_title, *args, **kwargs) + 'Yeah!'

    def what_do_you_do(self):
        """Just a simple method to describe the concept of singer.
        """

        return f'I am a {self.__class__.__name__.lower()} and I sing songs.'
...
class Songwriter(Musician):
    ...
    def what_do_you_do(self):
        ...
        return f'I am a {self.__class__.__name__.lower()} and I write songs.'
...
print(ringo)
print(Singer.__mro__)
print(ringo == Singer(name='Ringo Starr', vocals=Vocals.BACKGROUND_VOCALS))
print()
ringo = Songwriter(name='Ringo Starr', instrument=Instrument.DRUMS)
print(ringo)
print(ringo == Songwriter(name='Ringo Starr', instrument=Instrument.DRUMS))
print(ringo.what_do_you_do())
